...
public class Problem11 {
    ...
    //Very interesting! Take notes on hash value used in countDP function and the way it uses to represent different
    // boolean operations. Also the use of 'not' in counteff is very interesting
